      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            contextOptions = {
              recordVideo: {
                dir: './reports/videos/' + scenario.pickle.name // dir: `${env('VIDEO_PATH')}${scenario.pickle.name}`,
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return page.screenshot({
              path: "./reports/screenshots/".concat(scenario.pickle.name, ".png") // path: `${env('SCREENSHOT_PATH')}${scenario.pickle.name}.png`
